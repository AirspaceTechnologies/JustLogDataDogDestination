...
//                consolePrint("\(error)")
                return Logger(
                    logBuilder: nil,
                    logOutput: nil,
                    dateProvider: Date(),//SystemDateProvider(),
                    identifier: "no-op",
...
//                throw DDError(type: "ProgrammerError", message: Datadog.instance == nil
...
//                dateProvider: loggingFeature.dateProvider,
                identifier: "LOGGER", //resolveLoggerName(for: loggingFeature),
