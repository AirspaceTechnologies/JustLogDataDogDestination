...
internal struct LogEncoder {
    ...
    let timestampFormatter: DateFormatter = {
        ...
        formatter.dateFormat = "y-MM-dd'T'H:m:s.sssZ"
        return formatter
    }()
    ...
    func encode(_ log: Log, to encoder: Encoder) throws {
        ...
        try container.encode(timestampFormatter.string(from: log.date), forKey: .date)
...
//            try container.encode("yes", forKey: .networkReachability)
//            try container.encode(["wifi"], forKey: .networkAvailableInterfaces)
//            try container.encode(false, forKey: .networkConnectionSupportsIPv4)
//            try container.encode(false, forKey: .networkConnectionSupportsIPv6)
//            try container.encode(false, forKey: .networkConnectionIsExpensive)
